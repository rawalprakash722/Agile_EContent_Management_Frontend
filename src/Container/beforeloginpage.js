                        ...
                        <Carousel.Item interval={2000} style={{ color: "black" }}>
                            ...
                            <Carousel.Caption>
                                <div class="carousel-caption">
                                    ...
                                    <div id="image-caption" style={{ fontFamily: "Georgia, serif", color: "black", fontWeight: "bolder" }}></div>
                                </div>
                            </Carousel.Caption>
                        </Carousel.Item>
