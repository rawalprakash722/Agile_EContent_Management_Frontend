					...
					<div class="container">
						...
						<div class="row  justify-content-center text-center">
							<div class="col-sm-6 col-lg-4 col-xl-4 ">
								<div style={{height:"500px"}} class="single-person">
									<div class="person-image">
										<img style={{height:"250px",width:"250px"}}src="./images/member4.jpg" alt="" />
										<span class="icon">
											<i class="fab fa-html5"></i>
										</span>
									</div>
									<div class="person-info">
										<p class="full-name">Prakash Rawal</p>
							...
							<div style={{height:"300px"}} class="col-sm-6 col-lg-4 col-xl-4">
								<div style={{height:"500px"}} class="single-person">
									<div class="person-image">
										<img style={{height:"250px",width:"250px"}} src="./images/member2.png" alt="" />
										<span class="icon">
											<i class="fab fa-wordpress-simple"></i>
										</span>
									</div>
									<div class="person-info">
										<h6 className="full-name">Ujjwal khatri</h6>
							...
							<div class="col-sm-6 col-lg-4 col-xl-4">
								<div  style={{height:"500px"}}class="single-person">
									<div class="person-image">
										<img  style={{height:"250px",width:"250px"}} src="./images/member6.jpg" alt="" />
										<span class="icon">
											<i class="fab fa-angular"></i>
										</span>
									</div>
									<div class="person-info">
										<h3 class="full-name">Roshan nuire</h3>
						...
						<div class="row  justify-content-center text-center">
							<div style={{height:"300px"}} class="col-sm-6 col-lg-4 col-xl-4 ">
								<div  style={{height:"500px"}}class="single-person">
									<div class="person-image">
										<img style={{height:"250px",width:"250px"}} src="./images/member1.jpg" alt="" />
										<span class="icon">
											<i class="fab fa-html5"></i>
										</span>
									</div>
									<div class="person-info">
										<p class="full-name">Sadikshya Pandeya</p>
										<span class="speciality">UI/UX design</span>
										<div className="row">
											<ul>
												<Link title="Facebook" target="_blank" to="https://www.facebook.com/"><FaFacebook style={{ color: "black", fontSize: "20px", marginRight: "7px" }} /></Link>
							...
							<div class="col-sm-6 col-lg-4 col-xl-4">
								<div  style={{height:"500px"}}class="single-person">
									<div class="person-image">
										<img  style={{height:"250px",width:"250px"}} src="./images/member5.jpg" alt="" />
										<span class="icon">
											<i class="fab fa-wordpress-simple"></i>
										</span>
									</div>
									<div class="person-info">
										<h6 className="full-name">Parakram Lama</h6>
										<span class="speciality">Content Writer</span>
									</div>
									<div className="row">
										<ul>
							...
							<div class="col-sm-6 col-lg-4 col-xl-4">
								<div style={{height:"500px"}} class="single-person">
									<div class="person-image">
										<img style={{height:"250px",width:"250px"}} src="./images/member3.jpg" alt="" />
										<span class="icon">
											<i class="fab fa-angular"></i>
										</span>
									</div>
									<div class="person-info">
										<h3 class="full-name">Sandesh Singh</h3>
										<span class="speciality">Digital Marketing</span>
									</div>
									<div className="row">
										<ul>
